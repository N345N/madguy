            ...
            if ($result->num_rows > 0) {
                ...
                if (time() < $expirationDate) {
                    ...
                    if ($stmt->execute()) {
                        ...
                        recordSales($conn, $loggedInEmail, getPackagePrice($selectedPackage), 0, getPackagePrice($selectedPackage));
                    } else {
...
// Function to get package price based on selected plan
function getPackagePrice($package) {
    switch ($package) {
        case 'Fitness': return 125;
        case 'Zumba': return 125;
        case 'Gym': return 250;
        case 'All': return 350;
        default: return 0;
    }
